...
2) There is no software to install. Just extract the zip file content to the folder of your choice (except system folders like your "Program Files" folder).
...
Simple CSV files with a headers including Merge fields instructions. Simply load these file in the first tab. In the first example, see the field "FN" created using the content of the fields "F1" and "F3".
